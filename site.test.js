...
check(/<script src="analytics\.js\?v=ga4-3" defer><\/script>/.test(home) && /<script src="products\.js" defer><\/script>/.test(home), 'Home defer analytics และ canonical products.js โดยไม่ block initial render');
...
check([home, pdp, catalogHtml, promotions, guide, cart].every((page) => /analytics\.js\?v=ga4-3/.test(page)), 'ทุก flow หลักใช้ cache-busted GA4 analytics bundle เวอร์ชันเดียวกัน');
